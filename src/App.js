...
function App() {
  ...
  useEffect(() => {
    Promise.all([propertiesGetDetails(), propertiesGetHotelPhotos()])
      .then(([propertiesGetDetails, propertiesGetHotelPhotos]) => {
        ...
        dispatch(
          setListImages(
            listImagesHotel(propertiesGetHotelPhotos.data.hotelImages)
          )
        );
        ...
        dispatch(
          setDefaultData(
            listRoomImages(
              propertiesGetHotelPhotos.data.roomImages,
              propertiesGetDetails.data.data.body.propertyDescription
                .roomTypeNames
            )
          )
        );
